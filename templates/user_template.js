...
document.getElementById("header").innerHTML =
    ...
    + '</form>'
    + '<div class="d-flex">'
    + '<a class="btn btn-outline-secondary" role="button" href="create_listing.html">Crea annuncio</a>'
    + '<a class="btn btn-outline-primary rounded-end-0 ms-1" role="button" href="signup.html">Registrati</a>'
    + '<a class="btn btn-outline-primary rounded-start-0 border-start-0" role="button" href="signin.html">Accedi</a>'
    + '</div>'
    + '</nav>'
    ;
//html at page end
