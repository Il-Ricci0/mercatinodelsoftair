    ...
    if (!isset($_SESSION['logged_in'])) {
        ...
        <div class="w-100 d-flex justify-content-center">
            <div class="card m-5 p-4 d-inline">
                Ooops! per creare un club <a href="/mercatinodelsoftair/user/signin/">accedi</a> o <a href="/mercatinodelsoftair/user/signup/">registrati</a>.
            </div>
        </div>
        ';
    } else {
        ...
        <div class="w-100 d-flex justify-content-center">
            <div class="card form-card m-5 p-4">
                <form action="/mercatinodelsoftair/user/be_new_club/" method="POST" class="form-horizontal">
