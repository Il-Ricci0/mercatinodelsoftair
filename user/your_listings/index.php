        ...
        <div class="col bg-secondary">
            ...
            <div class="col">
                ...
                if (isset($_GET["search"])) {
                    ...
                    $search_words_query .= '%"';
                    $query = "SELECT id, title, description, price, category, (SELECT COUNT(listings.id) FROM listings WHERE status='active' AND user='" . $_SESSION["email"] . "' AND status='active' AND title LIKE " . $search_words_query . ") AS nrows FROM listings WHERE user='" . $_SESSION["email"] . "' AND status='active' AND title LIKE " . $search_words_query;

                } else {
                    $query = "SELECT id, title, description, price, category, (SELECT COUNT(listings.id) FROM listings WHERE status='active' AND user='" . $_SESSION["email"] . "' AND status='active') AS nrows FROM listings WHERE user='" . $_SESSION["email"] . "' AND status='active'";
                }
