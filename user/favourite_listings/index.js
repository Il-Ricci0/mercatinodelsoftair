...
function filter(id, category) {
    ...
    if (queryId == id && search == null) {
        window.location.href = '/mercatinodelsoftair/user/favourite_listings/';
    }
    else if (queryId == id && search != null) {
        window.location.href = '/mercatinodelsoftair/user/favourite_listings/?search=' + search;
    }
    else if (search != null) {
        window.location.href = '/mercatinodelsoftair/user/favourite_listings/?id=' + id + '&' + 'category=' + category + '&search=' + search;
    } else {
        window.location.href = '/mercatinodelsoftair/user/favourite_listings/?id=' + id + '&' + 'category=' + category;
    }
}
