...
<nav class="navbar bg-light p-2">
    ...
    <div class="position-absolute d-flex justify-content-center" id="search-panel">
        <div class="form-inline d-flex w-25" id="search-line">
            <input type="text" class="form-control rounded-end-0" placeholder="cerca qui il tuo usato softair" name="search" id="search">
    ...
    if (!isset($_SESSION['logged_in'])) {
        ...
        <a class="btn btn-outline-primary rounded-end-0 ms-1" role="button" href="/mercatinodelsoftair/user/new_club/">Crea club</a>
        <a class="btn btn-outline-primary rounded-start-0 border-start-0" role="button" href="/mercatinodelsoftair/user/join_club/">Unisciti a club</a>
            <a class="btn btn-outline-secondary mx-2" role="button" href="/mercatinodelsoftair/user/create_listing/">Crea annuncio</a>
